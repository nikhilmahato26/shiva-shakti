    ...
    <section id="poojas" className="section-pad relative overflow-hidden">
      ...
      <div className="container-luxe relative">
        <SectionTitle
          ...
          title="Traditional Kerala Poojas & Homas"
          subtitle="Performed by traditional Kerala Pandits and Poojaris, following authentic rituals passed down through generations — on your behalf, or with your remote participation."
        />
